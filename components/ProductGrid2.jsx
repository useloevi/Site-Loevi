...
const products = [
  ...
  ["028", "Argola Tradicional G", "Brincos banhados a prata", "Indisponível"],
  ["029", "Argola Quadrada", "Brincos banhados a prata", "Indisponível"],
  ...
  ["032", "Trio Turmalina", "3 Brincos banhados a prata com pedras", "Indisponível"],
...
export default function ProductGrid2() {
  ...
  return (
    <div id="brincos" className="product-grid product-grid--earrings">
